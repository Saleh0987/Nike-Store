    ...
    <>
      <div className={`flex items-center justify-between lg:flex-col lg:justify-center
        ...
        lg:justify-items-center'>
          ...
          <h1 className='text-5xl lg:text-4xl md:-text3xl sm:text-2xl font-bold text-slate-900 
        ...
        <div className='flex items-center justify-center max-w-xl relative lg:max-w-none w-full'>
          <img src={img} alt={`img/heading`}
            className={`w-auto object-fill transitions-theme ${ifExists ? 'h-60 lg:h-56 md:h-52 sm:h44 xsm:h-36 rotate-6 hover:-rotate-12' : 'h-72 lg:h-64 md:h-60 sm:h48 xsm:h-40 rotate-[19deg] hover:rotate-12'}`} />
        </div>
      </div>
    </>
  )
